...
주소
<select name="addr">
    <option value="성남시" <?php  if($majorprt =="성남시") echo "selected"; ?>>성남시</option>
    <option value="하남시" <?php  if($majorprt =="하남시") echo "selected"; ?>>하남시</option>
    <option value="수원시" <?php  if($majorprt =="수원시") echo "selected"; ?>>수원시</option>
    <option value="서울시" <?php  if($majorprt =="서울시") echo "selected"; ?>>서울시</option>
</select>
</div>
<div>
